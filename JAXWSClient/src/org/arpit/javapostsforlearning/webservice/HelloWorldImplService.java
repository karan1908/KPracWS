 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://webservice.javapostsforlearning.arpit.org/", wsdlLocation = "http://localhost:8181/WS/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8181/WS/HelloWorld?wsdl");
