...
public class SoapServiceServiceLocator extends org.apache.axis.client.Service implements com.ibm.soap.server.SoapServiceService {
    ...
    private java.lang.String SoapService_address = "http://localhost:8080/SoapWSApacheAxis/services/SoapService";
    ...
    public com.ibm.soap.server.SoapService getSoapService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.ibm.soap.server.SoapServiceSoapBindingStub _stub = new com.ibm.soap.server.SoapServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ibm.soap.server.SoapService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.ibm.soap.server.SoapServiceSoapBindingStub _stub = new com.ibm.soap.server.SoapServiceSoapBindingStub(new java.net.URL(SoapService_address), this);
                _stub.setPortName(getSoapServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://server.soap.ibm.com", "SoapServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://server.soap.ibm.com", "SoapService"));
        }
