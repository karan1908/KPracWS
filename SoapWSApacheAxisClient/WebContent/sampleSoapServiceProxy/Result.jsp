...
<jsp:useBean id="sampleSoapServiceProxyid" scope="session" class="com.ibm.soap.server.SoapServiceProxy" />
<%
...
case 10:
        gotMethod = true;
        com.ibm.soap.server.SoapService getSoapService10mtemp = sampleSoapServiceProxyid.getSoapService();
...
case 13:
        ...
        java.lang.String sayHello13mtemp = sampleSoapServiceProxyid.sayHello(name_1idTemp);
