...
/**
 * This enum defines the error codes that are produced during the application runtime.
 * These code are used by the Error class to generate custom error messages.
